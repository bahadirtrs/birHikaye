        ...
        <TouchableOpacity activeOpacity={1} onPress={props.modalPress} style={styles.centeredView}>
          <View style={styles.modalView}>
            <ScrollView style={{width:'100%', height:'100%', }} >
              <TouchableOpacity activeOpacity={1} style={{padding:20, margin:10}} >
              ...
              <Text style={styles.modalText}>
                ...
                Hikayeler her gün saat 00.00 da yayınlanır ve saat 23.59'de yayından kaldırılır.
                </Text><Text style={styles.modalText}>
                ...
                <Text style={styles.modalText}>
                Begenilen hikayeler, <Text style={{fontFamily:'GoogleSans-Medium'}} >Kaydedilenler</Text> sayfasında kayıt altında tutulur ve tekrardan okunabilir.
                </Text>
              </TouchableOpacity>
              </ScrollView>
          </View>
